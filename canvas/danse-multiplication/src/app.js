...
document.getElementById('valVitesse').innerText = `${[0.001, 0.01, 0.05, 0.1, 0.5, 1, 10, 100][parseInt(inputVitesse.value)]}`;
inputVitesse.oninput = () => document.getElementById('valVitesse').innerText = `${[0.001, 0.01, 0.05, 0.1, 0.5, 1, 10, 100][parseInt(inputVitesse.value)]}`;
document.getElementById('valEpaisseur').innerText = `${parseInt(inputEpaisseur.value) * 0.1}`;
inputEpaisseur.oninput = () => document.getElementById('valEpaisseur').innerText = `${parseInt(inputEpaisseur.value) * 0.1}`;
